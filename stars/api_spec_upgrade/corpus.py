...
CORPUS = (
    CorpusPrompt(
        id="api-spec-upgrade-safe-complete",
        prompt="Run the safe OpenAPI 3.0→3.1 upgrade graph on a corpus-backed spec.",
        tool="run",
        arguments={
            "entries": [
                {
            ...
            "profile": {
                ...
                "feature_vocabulary": {
                    "supported": [
                        {
                            "id": "openapi.json_schema.draft2020",
                            "class": "transformable",
                        }
                    ],
                    "unsupported": [
                        {
                            "id": "openapi.discriminator.mapping",
                            "class": "unsupported",
                        }
                    ],
                },
